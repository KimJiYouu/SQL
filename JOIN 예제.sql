...
SELECT E1.FIRST_NAME AS 사원, E2.FIRST_NAME AS 매니저
FROM EMPLOYEES E1 LEFT JOIN EMPLOYEES E2 ON E1.MANAGER_ID = E2.EMPLOYEE_ID;

--문제 11. 
---EMPLOYEES 테이블에서 left join하여 관리자(매니저)와, 매니저의 이름, 매니저의 급여 까지 출력하세요
---매니저 아이디가 없는 사람은 배제하고 급여는 역순으로 출력하세요
SELECT E.FIRST_NAME AS 사원명, E.SALARY AS 사원급여, E2.EMPLOYEE_ID AS 매니저아이디, E2.FIRST_NAME AS 매니저명, E2.SALARY AS 매니저급여
