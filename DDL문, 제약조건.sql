...
INSERT INTO DEPTS4 VALUES(10, 'CHARLIE', SYSDATE, '010...', 10000, 1000);
INSERT INTO DEPTS4 VALUES(10, 'CHARLIE', SYSDATE, '010...', 10000, 1000);

--참조무결성 (참조테이블의 PK가 아닌 값이 FK에 들어갈 수 없음) : INTEGRITY CONSTRAINT VIOLATED - PARENT KEY NOT FOUND
INSERT INTO DEPTS4 VALUES(20, 'CHARLIE', SYSDATE, '01011111111',10000,500); --LOCATIONS의 PK에 500이 없음

--도메인 무결성(값은 컬럼에 정의된 값이어야 한다) : CHECK CONSTRAINT VIOLATED
INSERT INTO DEPTS4 VALUES(30, 'CHARLIE', SYSDATE, '01022222222',-1000, 1000);
...
ALTER TABLE DEPTS5 MODIFY DEPT_NAME VARCHAR2(20) NOT NULL;
--제약조건 삭제
