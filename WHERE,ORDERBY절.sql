...
SELECT * FROM EMPLOYEES WHERE JOB_ID LIKE 'IT%'; --IT로 시작하는 값
SELECT * FROM EMPLOYEES WHERE HIRE_DATE LIKE '03%'; --03년으로 시작하는 값
SELECT * FROM EMPLOYEES WHERE HIRE_DATE LIKE '%12%'; -- 12가 포함된 값
SELECT * FROM EMPLOYEES WHERE HIRE_DATE LIKE '___05%';
SELECT * FROM EMPLOYEES WHERE EMAIL LIKE '_A%'; --A가 두번째에 위치하는 값
...
SELECT * FROM EMPLOYEES WHERE JOB_ID = 'IT_PROG' OR JOB_ID = 'FI_MGR' AND SALARY >= 6000; --FI_MGR 중 6000이상 OR IT_PROG
SELECT * FROM EMPLOYEES WHERE (JOB_ID = 'IT_PROG' OR JOB_ID = 'FI_MGR') AND SALARY >= 6000; --FI_MGR, IT_PROG 중 6000이상

--------------------------------------------------------------------------------
--ORDER BY 칼럼(엘레어스)
SELECT * FROM EMPLOYEES ORDER BY HIRE_DATE; --날짜 기준 ASC(기본값) 오름차순
